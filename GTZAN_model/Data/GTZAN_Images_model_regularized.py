...
# Load datasets
train_dataset = SiameseImageDataset(csv_file=r'C:\Users\Joe\Documents\GitHub\Resona\GTZAN_model\Data\images_original\train_pairs.csv')
val_dataset = SiameseImageDataset(csv_file=r'C:\Users\Joe\Documents\GitHub\Resona\GTZAN_model\Data\images_original\val_pairs.csv')
...
total = 0
samples_processed = 0
torch.save(model.state_dict(), 'GTZAN_30SEC_MODEL.pth')
